...
![5a32edfc76f3ee6b167243ca5c57046f](/blog/2020/11/04/redis/FA0854DD-745C-4BF6-887F-E24EFE220F27.png)  
Redis的qps可以达到10w/s，Redis将数据存储在内存中，读写操作不会因为磁盘的IO速度限制。基于内存的数据库和基于内存的数据库的区别：

![385707892665c62b9066ea4454d2e130](/blog/2020/11/04/redis/C4B4883F-AD48-449F-8C69-C5B8F7FE658C.png)
...
redis命令不区分大小写，但redis的key值区分大小写的。
  ...
  * string  
![df4a92860d08e455fbc63acbc283b54f](/blog/2020/11/04/redis/461FF8E5-C6E5-47E6-B9DC-2D6C2E8152F6.png)



其中: embstr和raw都是由SDS动态字符串构成的。SDS结构ruxiatu :  
![c51fd1b545290ce2f9265a9528e4410a](/blog/2020/11/04/redis/D464B7A2-2343-4F8B-BEE4-C029D69576CA.png)
  ...
  * list  
![6607248359f8fd3111476bb79757e809](/blog/2020/11/04/redis/1CC7E93B-61C4-4EA4-B227-92AC62C2C5EA.png)  
ziplist为连续的字节数组，每个元素的长度不同，结构如下。  
![172737c4984a5b1f0e26da4ff9176f7b](/blog/2020/11/04/redis/3AD4319D-F809-41EB-8979-B27ABCC252DD.png)  
元素的结构为：  
![4f8c905d288dfac268dc3f062d7f79eb](/blog/2020/11/04/redis/AB8A306E-3310-4BBC-8558-335C8F796C8D.png)  
quicklist是将ziplist和双向链表融合。  
![e5b343b0262823b7fa8164e09d3fb8c3](/blog/2020/11/04/redis/C7CD6992-FAE6-48C1-9462-C6C168439227.png)
  ...
  * set  
![ef4d0719648f37edc36d4505f4743ee2](/blog/2020/11/04/redis/821CD69E-1D94-4BA0-AC20-C1C83EE8AE5D.png)  
用hashtable实现时候，不关注value值。



![864ebb861cb880ef31bc8fbe8050aafd](/blog/2020/11/04/redis/36BF6D29-6856-4376-B6CD-C19A80B590A5.png)
  ...
  * zset  
![d3effffa6f1106edb6363ef0bcea2e8c](/blog/2020/11/04/redis/3268036B-1B22-4987-98C1-1D8757230B4B.png)  
跳表是拿空间换时间，来优化链表的查询效率。  
![88b42aaab8dba0b929df5d435332dc46](/blog/2020/11/04/redis/876F26BB-A8A6-46D6-98C4-EDC3DE13A864.png)
  ...
  * hash  
![db1ad8d489cdb4f0704f920775066537](/blog/2020/11/04/redis/33BBA5B1-59AD-4448-9802-5BAA8043BCE5.png)



redis中的hash在不满足ziplist的时候使用hashtable实现的。  
![def153c7a2aa16a51535c250b52ec677](/blog/2020/11/04/redis/970E50BF-B579-4FAD-9969-ADE504C48948.png)  
![9481c2d32fae59aea8659c5b498138bf](/blog/2020/11/04/redis/B1497AF7-9D35-4BFB-91A2-A151FC1BBFE7.png)  
这类结构容易存在扩容的问题，redis用rehash来解决；即当hashtable中的元素个数大于数组长度时，就开始搬迁到h[1]，完成后，删除旧的。rehash的过程会插入到每次的插入、删除等操作中。  
![9ee9159aa048fa76b62166621d4bf9ce](/blog/2020/11/04/redis/09521578-BDB4-4A81-92FC-B080D0B6E616.png)
...
![ee32618df2141b5acdb925fca6603ff0](/blog/2020/11/04/redis/5BAB97E2-2CA3-4EC7-93B9-694A0F205780.png)
...
![17dbbcf34c621554790721217541105f](/blog/2020/11/04/redis/5E0E7B40-5FC2-4DD3-90EA-1259116FCAF3.png)  
单个哨兵并不可靠，通常会设置三个哨兵；这样保证一个哨兵挂掉后还能进行redis的监控和主备切换；  
哨兵 + redis 主从的部署架构，是不会保证数据零丢失的，只能保证 redis 集群的高可用性。  
**脑裂** （master的假down机导致的）：  
![6a72a085cd8ffb268fd6a4695a3b57fe](/blog/2020/11/04/redis/31C4BCF4-8DFF-493F-A369-734D4A15F8EB.png)  
...
![f2233565f2fefdea897e068e15481464](/blog/2020/11/04/redis/7A499761-3B95-45BC-ADA8-D8228904138B.png)  
redis cluster采用的虚拟槽分区算法将数据分割到不同的节点。  
![ebc6f504cbefa4a9907b4cbbd95f0329](/blog/2020/11/04/redis/2FF35CF4-ECA7-4069-9789-A56CDBBF289B.png)
...
![0318b10f5a9ff6a6bbfcca7ce7c30b96](/blog/2020/11/04/redis/8E510CC6-6435-40A7-95C8-BF2006E15459.png)  
每个节点会保存一个clusterState结构来存储群居的节点信息：  
![0e7e64f00a8c37b7b806272403ba7e73](/blog/2020/11/04/redis/92C15C7E-EF52-402D-BD6B-BD57C3AE1A60.png)
...
redis持久化的意义在于故障恢复。  
![70158a15b825cf890467618368646fcd](/blog/2020/11/04/redis/52F05B2A-BC11-4CF7-B38A-4F709B1ACDB5.png)  
...
![7b95db2e65d1b5818fb429dbfa9110ca](/blog/2020/11/04/redis/185F3F74-CC7A-4F9C-B560-6185A6EB35CB.png)  
RDB的优点：
...
![57ebb501f8043b587e319b42a1248be3](/blog/2020/11/04/redis/F683068C-7F27-4ED7-9B5C-19FEA8AFD49C.png)  
...
![3b306e852ad5b8bb6add9cbd341e0c29](/blog/2020/11/04/redis/26B800B9-F656-4A80-AC49-7F666759EF76.png)
...
![3d2d31f94dda3721be5c096d4dd521bc](/blog/2020/11/04/redis/E2278078-572A-4C7B-AFFE-5F3CB935BF3E.png)
