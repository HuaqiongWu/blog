...
![78786394797ca1761aa5ae8004b0053b](images/odp框架/8BDB872F-5821-4C19-A106-08DC5B87BB14.png)
...
![27e92881c6c090280a1283bb84115b99](images/odp框架/D0A8B29A-369F-4118-AFBB-701C6D161B8A.png)
...
![759400b29a3314af4f7b66f7f8358031](images/odp框架/A7BCFBEC-AB34-4076-9E3E-4EF165ECF596.png)
...
![fe6a18b2b09b4a49701a88104ff77a93](images/odp框架/99672AAE-1FF1-4D3E-9E34-325B7CEE8FF4.png)
...
![e4033c5ca25e9503a8cb81345211e087](images/odp框架/28E685C3-B4EE-4ACD-9753-AC368B17A627.png)

可以看到请求转发到 /dunker-pro/index.php 文件；

Index.php入口文件中这两行的意义：  
![7be03ddf96f1d0c41633920c98b8b81d](images/odp框架/3C2EB01D-94C8-4FF6-A472-42A52DA23AAB.png)
...
![1d1c2789e9ebc6b2f143bd31965ad625](images/odp框架/28EC82CE-C2AD-4B89-8BC2-B48FD9BA4237.png)

首先路由是使用的aip_router，自定义的路由如下：

![de877e24235825a8e53d81b8d65135ce](images/odp框架/FDDB5C6C-BF7A-44D9-9DD7-338E7C51D60C.png)
...
![d66a6cde0c2678cfa63a671fe7c993fc](images/odp框架/AD4FA73B-B4CD-42A3-A3C1-69C6BB4879AC.png)

#### 5、ap插件

AP插件会触发以下的几个hook函数：  
![3edb1d71a1c0031a24a5d6705f6274f7](images/odp框架/AF81EEB3-D8F9-4275-8FB1-68CFF6543BB3.png)  
插件Init中实现了routerStartUp方法，主要功能是初始化、参数格式化和打印URI请求日志（URI、开始时间、当前内存占用）。  
![e0d507bb19f4e1ab72cbb02af592f5ad](images/odp框架/D5160B59-DD7F-4EB9-B235-CBDF8E8C6822.png)

dispatchLoopShutdown方法，主要功能是打印日志，包括URI、耗时、内存占用；  
![eef06b4c4ad237f19f0881591cecaf13](images/odp框架/856B4DF1-CF45-4899-AFE3-B7905422E93C.png)
